...
\subsection{快速莫比乌斯/沃尔什变换}

\lstinputlisting[language=C++]{./code/3/3.8-fwt.cpp}

\subsection{子集卷积}

\lstinputlisting[language=C++]{./code/3/3.9-subsetcov.cpp}
...
\lstinputlisting[language=C++]{./code/5/5.3-manacher.cpp}

上面的太丑了 下面另一版

\lstinputlisting[language=C++]{./code/5/5.3-manacher2.cpp}

\subsection{回文自动机}

\lstinputlisting[language=C++]{./code/5/5.4-pam.cpp}

\subsection{字符串哈希}

\lstinputlisting[language=C++]{./code/5/5.5-hashstr.cpp}

\subsection{后缀数组}

\lstinputlisting[language=C++]{./code/5/5.6-sa.cpp}

\subsection{AC 自动机}

\lstinputlisting[language=C++]{./code/5/5.7-acam.cpp}

\section{计算几何}

\subsection{计算几何模板 - 吉如一}

我也看不懂先放上来再说

\lstinputlisting[language=C++]{./code/6/6.1-jry.cpp}

\section{STL}

\subsection{算法库}

\input{code/7/7.1-algorithm.tex}

\section{杂项}

\subsection{二项式系数相关}

\input{code/8/8.1-binom.tex}

\subsection{顶和底相关}

\input{code/8/8.2-floorceil.tex}

\subsection{生成函数相关}

\input{code/8/8.3-genfunc.tex}

\subsection{Tips}

\input{code/8/8.4-tips.tex}
